      ...
      return {
         ...
         createCard: builder.mutation<Card, { body: CreateCardArgs; id: string }>({
            query: ({ body, id }) => {
               ...
               if (body.questionImg instanceof File) {
                  formData.append('questionImg', body.questionImg)
               }

               if (body.answerImg instanceof File) {
         ...
         updateCard: builder.mutation<Card, { id: string; body: UpdateCardArgs }>({
            query: ({ body, id }) => {
               const hasFiles = body.questionImg instanceof File || body.answerImg instanceof File
